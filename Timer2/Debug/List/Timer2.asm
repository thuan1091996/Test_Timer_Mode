...
; 0000 0031 DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (1<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	LDI  R30,LOW(8)
	OUT  0x17,R30
...
; 0000 0045 // OC2 output: Non-Inverted PWM
; 0000 0046 // Timer Period: 0.032 ms
; 0000 0047 // Output Pulse(s):
; 0000 0048 // OC2 Period: 0.032 ms Width: 3.2627 us
; 0000 0049 ASSR=0<<AS2;
	OUT  0x22,R30
; 0000 004A TCCR2=(1<<PWM2) | (1<<COM21) | (0<<COM20) | (1<<CTC2) | (0<<CS22) | (0<<CS21) | (1<<CS20);
	LDI  R30,LOW(105)
	OUT  0x25,R30
...
; 0000 004F TIMSK=(1<<OCIE2) | (1<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<TOIE0);
	LDI  R30,LOW(192)
	OUT  0x39,R30
; 0000 0050 
